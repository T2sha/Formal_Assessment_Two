...
function App() {
    ...
    sessionStorage.setItem('activeUser', 'Natasha');
    ...
    useEffect(() => {
        axios.post('http://localhost/assessmentTwo/readUserPosts.php', userId)
        .then((res) => {
            let data = res.data;
    ...
    const addNewPost = (e) => {
        ...
        axios.post('http://localhost/assessmentTwo/addPost.php', postMessage)
        .then((res) => {
            let data = res.data;
            setRenderPost(true);
        });
